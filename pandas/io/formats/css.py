...
class CSSResolver(object):
    ...
    def size_to_pt(self, in_val, em_pt=None, conversions=UNIT_RATIOS):
        def _error():
            warnings.warn('Unhandled size: {val!r}'
                          .format(val=in_val), CSSWarning)
    ...
    expand_border_color = _side_expander('border-{}-color')
    expand_border_style = _side_expander('border-{}-style')
    expand_border_width = _side_expander('border-{}-width')
    expand_margin = _side_expander('margin-{}')
    expand_padding = _side_expander('padding-{}')

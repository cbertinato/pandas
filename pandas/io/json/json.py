...
class JSONTableWriter(FrameWriter):
    ...
    def write(self):
        ...
        serialized = ('{{"schema": {schema}, "data": {data}}}'
                      .format(schema=dumps(self.schema), data=data))
        return serialized
...
class Parser(object):
    ...
    def check_keys_split(self, decoded):
        ...
        if bad_keys:
            ...
            raise ValueError(u("JSON data had unexpected key(s): {keys}")
                             .format(keys=pprint_thing(bad_keys)))
